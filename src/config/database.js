...
INSERT INTO usuarios (
    ...
    email,
    senha
) SELECT 'Gustavo Bossolani', 'gustavo@alura.com.br', '123' WHERE NOT EXISTS (SELECT * FROM usuarios WHERE email = 'gustavo@alura.com.br')
`;
...
INSERT INTO livros (
    ...
    preco,
    descricao
) SELECT 'Backend com Java', 44.99, 'Como desenvolver um backend com Java.' WHERE NOT EXISTS (SELECT * FROM livros WHERE titulo = 'Backend com Java')
`;
